# Operator Quickstart — Community Food Service Operations

Shortest path from clone to a verified local dry-run for **ISIC 5610** (`cloud-itonami-isic-5610`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-5610.git
cd cloud-itonami-isic-5610
```
...
- Blueprint governor key: `food-service-governor`
- Likely source path: `src/**/food-service-governor.cljc`
